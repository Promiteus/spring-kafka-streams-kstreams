...
import com.roman.kafkastreams.componets.KafkaSteamsPurchaseSelectKeyTopology;
...
public class KafkaProducerPurchaseSelectKey implements IPermProducer {
    ...
    public void toTopic() {
        ...
        this.send(this.producer, KafkaSteamsPurchaseSelectKeyTopology.INP_TOPIC, key, value);
    }
