...
public class KafkaStreamsPurchaseJoinTranslation implements IKafkaStreamTopology {
    ...
    public void process(StreamsBuilder streamsBuilder) {
        ...
        KStream<String, CorrelatePurchase> joinedKStream = sourceStreams1.join(sourceStreams2, purchaseJoiner, JoinWindows.of(Duration.ofMillis(1100)), StreamJoined.with(Serdes.String(), purchaseSerde, purchaseSerde));
